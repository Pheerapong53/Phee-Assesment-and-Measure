...
export default function EditLeaveHistory() {
...
<div className="cotainerDetail">
      ...
      <FormControl sx={{ m: 1, width: 500 }} variant="outlined">
        ...
        <a href="/PageEditInsertScore"><Button variant="outlined" sx={{minWidth: 242, m:1  }}>ย้อนกลับ</Button></a>
        <a href="/PageEditInsertScore"><Button variant="outlined" sx={{minWidth: 242, m:1  }}>บันทึก</Button></a>
        </div>
        </div>
</React.Fragment>
  );
